...
var Json = [
	...
	{
		"name":"FirstRoom", 
		"text":'A good story needs suspense and vanilla, and [wave amp=50 freq=2]burgers[/wave] lots of BURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERSBURGERS',
		"decisions": [
			{
			"target_page":"Intro",
			"label":'To the Intro!',
